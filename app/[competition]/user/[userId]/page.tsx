    ...
    <div className="flex-1 flex flex-col">
      <div className="max-w-2xl mx-auto px-4 pt-5 pb-10 w-full flex flex-col gap-5">
        ...
        <div className="flex items-center gap-1.5 text-xs" style={{ color: MUTED }}>
          ...
          <span>/</span>
          <Link href={`/${competitionSlug}/leaderboard`} className="hover:underline" style={{ color: MUTED }}>Rankings</Link>
          <span>/</span>
        ...
        {/* Back links */}
        <div className="flex items-center justify-between">
          <Link href={`/${competitionSlug}/leaderboard`} className="text-xs hover:underline" style={{ color: MUTED }}>
            ← Global Rankings
          </Link>
